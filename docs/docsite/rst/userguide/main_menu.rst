...
.. note::
  ...
  .. image:: ../common/images/configure-awx-system-misc-preview-newui.png
     :alt: Enabling preview of new user interface
  ...
  .. image:: ../common/images/ug-dashboard-preview-banner.png
     :alt: An image of a dashboard with the word dashboard
...
.. |activitystream| image:: ../common/images/activitystream.png
   :alt: It shows image of activity stream icon

.. image:: ../common/images/ug-dashboard-top-nav.png
   :alt: It shows an image of AWX dashboard with Activity Screen icon
...
.. image:: ../common/images/ug-dashboard-topsummary.png
   :alt: An image of Job Status analytics dashboard 
...
.. image:: ../common/images/ug-dashboard-recent-jobs.png
   :alt: It shows a summary of the most recently used jobs
...
.. image:: ../common/images/ug-dashboard-recent-templates.png
   :alt: It shows a summary of the most recently used templates
...
.. image:: ../common/images/ug-dashboard-jobs-view.png
   :alt: It shows all the jobs that have ran, including projects, templates, management jobs, SCM updates, playbook runs, etc.
...
.. image:: ../common/images/ug-dashboard-schedule-view.png
   :alt: It shows all the scheduled jobs that are configured
...
.. |Users - Activity Stream| image:: ../common/images/users-activity-stream.png
   :alt: It shows a summary of the recent activity on Activity Stream dashboard.
...
.. |examine| image:: ../common/images/examine-button.png
   :alt: It shows the image of examine button

|event log|

.. |event log| image:: ../common/images/activity-stream-event-log.png
   :alt: It shows the event log of an Activity Stream instance
