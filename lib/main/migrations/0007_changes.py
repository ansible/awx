...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AuditTrail.description'
        db.delete_column(u'main_audittrail', 'description')

        # Deleting field 'AuditTrail.creation_date'
        db.delete_column(u'main_audittrail', 'creation_date')

        # Deleting field 'AuditTrail.active'
        db.delete_column(u'main_audittrail', 'active')

        # Deleting field 'AuditTrail.name'
        db.delete_column(u'main_audittrail', 'name')
    ...
    def backwards(self, orm):
        # Adding field 'AuditTrail.description'
        db.add_column(u'main_audittrail', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'AuditTrail.creation_date'
        db.add_column(u'main_audittrail', 'creation_date',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 3, 24, 0, 0), blank=True),
                      keep_default=False)
        ...
        # Adding field 'AuditTrail.name'
        db.add_column(u'main_audittrail', 'name',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2013, 3, 24, 0, 0), max_length=512, unique=True),
                      keep_default=False)

        # Adding field 'AuditTrail.created_by'
        db.add_column(u'main_audittrail', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['auth.User'], on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding M2M table for field tags on 'AuditTrail'
        db.create_table(u'main_audittrail_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('audittrail', models.ForeignKey(orm['main.audittrail'], null=False)),
            ('tag', models.ForeignKey(orm['main.tag'], null=False))
        ))
        db.create_unique(u'main_audittrail_tags', ['audittrail_id', 'tag_id'])

        # Adding M2M table for field audit_trail on 'AuditTrail'
        db.create_table(u'main_audittrail_audit_trail', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        db.create_unique(u'main_audittrail_audit_trail', ['from_audittrail_id', 'to_audittrail_id'])

        # Adding M2M table for field organization on 'Team'
        db.create_table(u'main_team_organization', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('team', models.ForeignKey(orm['main.team'], null=False)),
            ('organization', models.ForeignKey(orm['main.organization'], null=False))
        ))
        db.create_unique(u'main_team_organization', ['team_id', 'organization_id'])
