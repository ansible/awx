...
the directives are defined in `../ui/client/src/network-ui/network.ui.app.js`.

* See: [network.ui.app.js](../ui/client/src/network-ui/network.ui.app.js)
```
    .directive('awxNetDeviceDetail', deviceDetail.deviceDetail)
```

* See: [device.detail.directive.js](../ui/client/src/network-ui/device.detail.directive.js)
```
...
passed to it.  The Link model is defined in the `../ui/client/src/network-ui/models.js` file.

* See: [link.directive.js](../ui/client/src/network-ui/link.directive.js)
* See: [link.partial.svg](../ui/client/src/network-ui/link.partial.svg)

* See: [network_ui.html](../ui/client/src/network-ui/network_ui.partial.svg)
```
...
* See: [models.js](../ui/client/src/network-ui/models.js)
```
...
* See: [inventory_toolbox.html](../ui/client/src/network-ui/inventory_toolbox.partial.svg)
```
...
in `../ui/client/src/network-ui/network_ui.partial.svg`.  Elements drawn first will be hidden behind
...
* See: [style.less](../ui/client/src/network-ui/style.less)
...
* See: [network_ui.partial.svg](../ui/client/src/network-ui/network_ui.partial.svg#L3)
...
* See: [network.ui.controller.js](../ui/client/src/network-ui/network.ui.controller.js)
...
* See: [link.js](../ui/client/src/network-ui/link.js)

The link FSM diagram has an equivalent machine readable representation in `designs/link.yml`. This
representation is useful for comparing the current implementation in `../ui/client/src/network-ui/link.js` to the design to see if they
...
```
    ./tools/fsm_generate_diffs.py designs/link.yml ./../ui/client/src/network-ui/link.js
```
...
[fsm.State](../ui/client/src/network-ui/fsm.js#L36) will provide empty `start` and `end` functions that
can be overridden as necessary.

* See: [fsm.js](../ui/client/src/network-ui/fsm.js#L2)
...
* See: [models.js](../ui/client/src/network-ui/models.js#302)
...
* See: [link.js](../ui/client/src/network-ui/link.js#L40)
...
* See: [link.js](../ui/client/src/network-ui/link.js#L134)
...
The models defined in [models.js](../ui/client/src/network-ui/models.js) are:
...
* See: [messages.js](../ui/client/src/network-ui/messages.js)

The messages defined are [messages.js](../ui/client/src/network-ui/messages.js):
...
* See: [network.ui.controller.js](../ui/client/src/network-ui/network.ui.controller.js#L115)
...
* Add a template in `widgets` for the new widget with name [inventory_toolbox.partial.svg](../ui/client/src/network-ui/inventory_toolbox.partial.svg)
...
* Add a directive that loads that template in `src/network-ui` with name [inventory.toolbox.directive.js](../ui/client/src/network-ui/inventory.toolbox.directive.js)
...
* Register the directive with the network UI application in [network.ui.app.js](../ui/client/src/network-ui/network.ui.app.js#L61) using name `awxNetInventoryToolbox`
...
* Add a tag that loads the directive into an existing template in `src/network-ui` in [network_ui.partial.svg](../ui/client/src/network-ui/network_ui.partial.svg#L94)
...
* Decide if you need any new messages to communicate between the UI and the server or between pieces of the UI.
  If so, add them to [messages.js](../ui/client/src/network-ui/messages.js#L251)
...
See: [toolbox.fsm.js](../ui/client/src/network-ui/toolbox.fsm.js)

* Add the FSM implementation to a FSMController in [network.ui.controller.js](../ui/client/src/network-ui/network.ui.controller.js#L145)
