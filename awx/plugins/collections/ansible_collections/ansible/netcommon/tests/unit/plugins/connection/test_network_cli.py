...
class TestConnectionClass(unittest.TestCase):
    ...
    @patch('ansible_collections.ansible.netcommon.plugins.connection.network_cli.terminal_loader')
    ...
    @patch('ansible_collections.ansible.netcommon.plugins.connection.network_cli.Connection._get_terminal_std_re')
    @patch('ansible_collections.ansible.netcommon.plugins.connection.network_cli.Connection._connect')
