    ...
    [
        ...
        (
            {'id': 100, 'name': 'Test', 'job_type': 'run', 'launch_type': 'manual', 'organization': Organization(id=1, name='')},
            {
                ...
                AutomationControllerJobScope.CLAIM_LAUNCH_TYPE: 'manual',
                AutomationControllerJobScope.CLAIM_ORGANIZATION_ID: 1,
                AutomationControllerJobScope.CLAIM_INSTANCE_GROUP_NAME: None,
                AutomationControllerJobScope.CLAIM_INSTANCE_GROUP_ID: None,
                AutomationControllerJobScope.CLAIM_PLAYBOOK_NAME: '',
                AutomationControllerJobScope.CLAIM_ORGANIZATION_NAME: '',
                AutomationControllerJobScope.CLAIM_ORGANIZATION_ID: 1,
                AutomationControllerJobScope.CLAIM_UNIFIED_JOB_TEMPLATE_ID: None,
                AutomationControllerJobScope.CLAIM_UNIFIED_JOB_TEMPLATE_NAME: None,
            },
        ),
    ],
)
    ...
    [
        ...
        (
            ...
            },
            {
                ...
                AutomationControllerJobScope.CLAIM_INSTANCE_GROUP_NAME: None,
                AutomationControllerJobScope.CLAIM_INSTANCE_GROUP_ID: None,
                AutomationControllerJobScope.CLAIM_ORGANIZATION_NAME: None,
                AutomationControllerJobScope.CLAIM_ORGANIZATION_ID: None,
                AutomationControllerJobScope.CLAIM_UNIFIED_JOB_TEMPLATE_ID: None,
                AutomationControllerJobScope.CLAIM_UNIFIED_JOB_TEMPLATE_NAME: None,
            },
        ),
