...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JobHostSummary.host'
        # Removing unique constraint on 'JobHostSummary', fields ['job', 'host']
        db.delete_unique(u'main_jobhostsummary', ['job_id', 'host_id'])

        # Adding unique constraint on 'JobHostSummary', fields ['job', 'host_name']
        db.create_unique(u'main_jobhostsummary', ['job_id', 'host_name'])
        db.alter_column(u'main_jobhostsummary', 'host_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, default=None, on_delete=models.SET_NULL, to=orm['main.Host']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'JobHostSummary.host'
        raise RuntimeError("Cannot reverse this migration. 'JobHostSummary.host' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'JobHostSummary.host'
        db.alter_column(u'main_jobhostsummary', 'host_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Host']))
