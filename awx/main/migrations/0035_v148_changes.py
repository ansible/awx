...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'main_inventoryupdatenew', (
            ...
            ('credential', self.gf('django.db.models.fields.related.ForeignKey')(related_name='inventoryupdatenews', on_delete=models.SET_NULL, default=None, to=orm['main.Credential'], blank=True, null=True)),
        ...
        db.create_table(u'main_unifiedjob', (
            ...
            ('unified_job_template', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='unifiedjob_unified_jobs', null=True, on_delete=models.SET_NULL, to=orm['main.UnifiedJobTemplate'])),
            ('launch_type', self.gf('django.db.models.fields.CharField')(default='manual', max_length=20)),
            ('schedule', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main.Schedule'], null=True, on_delete=models.SET_NULL)),
        ...
        # Adding M2M table for field dependent_jobs on 'UnifiedJob'
        m2m_table_name = db.shorten_name(u'main_unifiedjob_dependent_jobs')
        ...
        db.create_table(u'main_schedule', (
            ...
            ('unified_job_template', self.gf('django.db.models.fields.related.ForeignKey')(related_name='schedules', to=orm['main.UnifiedJobTemplate'])),
            ...
            ('next_run', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True)),
        ))
        ...
        db.create_table(u'main_inventorysourcenew', (
            ...
            ('source_path', self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True)),
            ('source_vars', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('credential', self.gf('django.db.models.fields.related.ForeignKey')(related_name='inventorysourcenews', on_delete=models.SET_NULL, default=None, to=orm['main.Credential'], blank=True, null=True)),
            ('source_regions', self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True)),
            ('overwrite', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('overwrite_vars', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('group', self.gf('awx.main.fields.AutoOneToOneField')(default=None, related_name='new_inventory_source', unique=True, null=True, to=orm['main.Group'])),
        ))
        ...
        db.create_table(u'main_projectnew', (
            ...
            ('credential', self.gf('django.db.models.fields.related.ForeignKey')(related_name='projectnews', on_delete=models.SET_NULL, default=None, to=orm['main.Credential'], blank=True, null=True)),
        ...
        db.create_table(u'main_projectupdatenew', (
            ...
            ('scm_clean', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('scm_delete_on_update', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('credential', self.gf('django.db.models.fields.related.ForeignKey')(related_name='projectupdatenews', on_delete=models.SET_NULL, default=None, to=orm['main.Credential'], blank=True, null=True)),
        ...
        db.create_table(u'main_unifiedjobtemplate', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('old_pk', self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True)),
            ('current_job', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='unifiedjobtemplate_as_current_job+', null=True, on_delete=models.SET_NULL, to=orm['main.UnifiedJob'])),
            ('last_job', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='unifiedjobtemplate_as_last_job+', null=True, on_delete=models.SET_NULL, to=orm['main.UnifiedJob'])),
            ...
            ('next_schedule', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='unifiedjobtemplate_as_next_schedule+', null=True, on_delete=models.SET_NULL, to=orm['main.Schedule'])),
        ...
        db.add_column(u'main_projectupdate', 'credential',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='projectupdates', on_delete=models.SET_NULL, default=None, to=orm['main.Credential'], blank=True, null=True),
                      keep_default=False)
        ...
        db.add_column(u'main_host', 'new_last_job',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='hosts_as_last_job+', null=True, on_delete=models.SET_NULL, to=orm['main.JobNew']),
                      keep_default=False)
        ...
        # Changing field 'JobHostSummary.job'
        db.alter_column(u'main_jobhostsummary', 'job_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['main.Job']))
        ...
        db.add_column(u'main_inventoryupdate', 'credential',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='inventoryupdates', on_delete=models.SET_NULL, default=None, to=orm['main.Credential'], blank=True, null=True),
                      keep_default=False)
        ...
        # Adding field 'Credential.vault_password'
        db.add_column(u'main_credential', 'vault_password',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True),
                      keep_default=False)
        ...
        # Adding M2M table for field schedule on 'ActivityStream'
        m2m_table_name = db.shorten_name(u'main_activitystream_schedule')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('activitystream', models.ForeignKey(orm['main.activitystream'], null=False)),
            ('schedule', models.ForeignKey(orm['main.schedule'], null=False))
        ))
        db.create_unique(m2m_table_name, ['activitystream_id', 'schedule_id'])
        ...
        # Changing field 'Project.current_update'
        db.alter_column(u'main_project', 'current_update_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['main.ProjectUpdate']))

        # Changing field 'Project.last_update'
        db.alter_column(u'main_project', 'last_update_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['main.ProjectUpdate']))

        # Changing field 'Project.credential'
        db.alter_column(u'main_project', 'credential_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['main.Credential'], null=True))
        ...
        # Changing field 'InventorySource.current_update'
        db.alter_column(u'main_inventorysource', 'current_update_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['main.InventoryUpdate']))

        # Changing field 'InventorySource.last_update'
        db.alter_column(u'main_inventorysource', 'last_update_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['main.InventoryUpdate']))

        # Changing field 'InventorySource.credential'
        db.alter_column(u'main_inventorysource', 'credential_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['main.Credential'], null=True))
        ...
        # Changing field 'JobEvent.job'
        db.alter_column(u'main_jobevent', 'job_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['main.Job']))
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field dependent_jobs on 'UnifiedJob'
        db.delete_table(db.shorten_name(u'main_unifiedjob_dependent_jobs'))
        ...
        # Changing field 'JobHostSummary.job'
        db.alter_column(u'main_jobhostsummary', 'job_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main.Job']))
        ...
        # Deleting field 'Credential.vault_password'
        db.delete_column(u'main_credential', 'vault_password')
        ...
        # Removing M2M table for field schedule on 'ActivityStream'
        db.delete_table(db.shorten_name(u'main_activitystream_schedule'))
        ...
        # Changing field 'Project.current_update'
        db.alter_column(u'main_project', 'current_update_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['main.ProjectUpdate']))

        # Changing field 'Project.last_update'
        db.alter_column(u'main_project', 'last_update_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['main.ProjectUpdate']))

        # Changing field 'Project.credential'
        db.alter_column(u'main_project', 'credential_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['main.Credential']))
        ...
        # Changing field 'InventorySource.current_update'
        db.alter_column(u'main_inventorysource', 'current_update_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['main.InventoryUpdate']))

        # Changing field 'InventorySource.last_update'
        db.alter_column(u'main_inventorysource', 'last_update_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['main.InventoryUpdate']))

        # Changing field 'InventorySource.credential'
        db.alter_column(u'main_inventorysource', 'credential_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['main.Credential']))
        ...
        # Changing field 'JobEvent.job'
        db.alter_column(u'main_jobevent', 'job_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main.Job']))
