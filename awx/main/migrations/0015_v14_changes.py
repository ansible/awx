...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectUpdate.job_args'
        db.alter_column(u'main_projectupdate', 'job_args', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Job.job_args'
        db.alter_column(u'main_job', 'job_args', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'ProjectUpdate.job_args'
        db.alter_column(u'main_projectupdate', 'job_args', self.gf('django.db.models.fields.CharField')(max_length=1024))
