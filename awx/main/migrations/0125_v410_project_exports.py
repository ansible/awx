    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scm_revision', models.CharField(blank=True, default='', editable=False, help_text='The SCM Revision returned by this update for the given project and branch.', max_length=1024, verbose_name='SCM Revision')),
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ('pk',),
                'index_together': {('project_export', 'start_line'), ('project_export', 'end_line'), ('project_export', 'uuid'), ('project_export', 'event')},
            },
        ),
    ]
