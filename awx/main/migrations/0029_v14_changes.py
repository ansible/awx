...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectUpdate.result_stdout_file'
        db.add_column(u'main_projectupdate', 'result_stdout_file',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Job.result_stdout_file'
        db.add_column(u'main_job', 'result_stdout_file',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


       # Adding field 'InventoryUpdate.result_stdout_file'
        db.add_column(u'main_inventoryupdate', 'result_stdout_file',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ProjectUpdate.result_stdout_file'
        db.delete_column(u'main_projectupdate', 'result_stdout_file')

        # Deleting field 'Job.result_stdout_file'
        db.delete_column(u'main_job', 'result_stdout_file')
