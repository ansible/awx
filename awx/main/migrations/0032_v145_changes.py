...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ActivityStream.object1_id'
        db.delete_column(u'main_activitystream', 'object1_id')

        # Deleting field 'ActivityStream.object1_type'
        db.delete_column(u'main_activitystream', 'object1_type')

        # Deleting field 'ActivityStream.object2_id'
        db.delete_column(u'main_activitystream', 'object2_id')

        # Deleting field 'ActivityStream.object2_type'
        db.delete_column(u'main_activitystream', 'object2_type')

    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration. 'ActivityStream.object1_id' and its values cannot be restored.")
