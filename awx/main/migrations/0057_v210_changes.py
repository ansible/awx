...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Schedule.extra_data'
        db.add_column(u'main_schedule', 'extra_data',
                      self.gf('jsonfield.fields.JSONField')(default={}, blank=True),
                      keep_default=False)

        # Adding field 'SystemJob.extra_vars'
        db.add_column(u'main_systemjob', 'extra_vars',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Schedule.extra_data'
        db.delete_column(u'main_schedule', 'extra_data')

        # Deleting field 'SystemJob.extra_vars'
        db.delete_column(u'main_systemjob', 'extra_vars')
