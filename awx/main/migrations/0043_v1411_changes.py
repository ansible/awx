...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobTemplate.vars_prompt_on_launch'
        db.add_column(u'main_jobtemplate', 'vars_prompt_on_launch',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobTemplate.vars_prompt_on_launch'
        db.delete_column(u'main_jobtemplate', 'vars_prompt_on_launch')
    ...
    models = {
        ...
        'main.jobtemplate': {
            ...
            u'unifiedjobtemplate_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['main.UnifiedJobTemplate']", 'unique': 'True', 'primary_key': 'True'}),
            'vars_prompt_on_launch': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'verbosity': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'blank': 'True'})
        },
        'main.organization': {
