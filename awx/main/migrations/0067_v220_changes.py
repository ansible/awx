...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Credential.sudo_password'
        db.delete_column(u'main_credential', 'sudo_password')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Credential.sudo_password'
        db.add_column(u'main_credential', 'sudo_password',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True),
                      keep_default=False)
