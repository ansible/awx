...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field custom_inventory_script on 'ActivityStream'
        m2m_table_name = db.shorten_name(u'main_activitystream_custom_inventory_script')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('activitystream', models.ForeignKey(orm['main.activitystream'], null=False)),
            ('custominventoryscript', models.ForeignKey(orm['main.custominventoryscript'], null=False))
        ))
        db.create_unique(m2m_table_name, ['activitystream_id', 'custominventoryscript_id'])

    def backwards(self, orm):
        # Removing M2M table for field custom_inventory_script on 'ActivityStream'
        db.delete_table(db.shorten_name(u'main_activitystream_custom_inventory_script'))
