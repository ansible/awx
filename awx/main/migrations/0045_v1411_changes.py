...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'main_jobtemplate', 'vars_prompt_on_launch', 'ask_variables_on_launch')


    def backwards(self, orm):
        db.rename_column(u'main_jobtemplate', 'ask_variables_on_launch', 'vars_prompt_on_launch')
