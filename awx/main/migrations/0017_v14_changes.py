...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.hosts_with_active_failures'
        db.add_column(u'main_group', 'hosts_with_active_failures',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Inventory.hosts_with_active_failures'
        db.add_column(u'main_inventory', 'hosts_with_active_failures',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.hosts_with_active_failures'
        db.delete_column(u'main_group', 'hosts_with_active_failures')

        # Deleting field 'Inventory.hosts_with_active_failures'
        db.delete_column(u'main_inventory', 'hosts_with_active_failures')
