...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobHostSummary.host_name'
        db.add_column(u'main_jobhostsummary', 'host_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1024),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobHostSummary.host_name'
        db.delete_column(u'main_jobhostsummary', 'host_name')
