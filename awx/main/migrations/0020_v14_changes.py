...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.total_hosts'
        db.add_column(u'main_group', 'total_hosts',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Group.total_groups'
        db.add_column(u'main_group', 'total_groups',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Group.groups_with_active_failures'
        db.add_column(u'main_group', 'groups_with_active_failures',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Inventory.total_hosts'
        db.add_column(u'main_inventory', 'total_hosts',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Inventory.total_groups'
        db.add_column(u'main_inventory', 'total_groups',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Inventory.groups_with_active_failures'
        db.add_column(u'main_inventory', 'groups_with_active_failures',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Inventory.total_inventory_sources'
        db.add_column(u'main_inventory', 'total_inventory_sources',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Inventory.inventory_sources_with_failures'
        db.add_column(u'main_inventory', 'inventory_sources_with_failures',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.total_hosts'
        db.delete_column(u'main_group', 'total_hosts')

        # Deleting field 'Group.total_groups'
        db.delete_column(u'main_group', 'total_groups')

        # Deleting field 'Group.groups_with_active_failures'
        db.delete_column(u'main_group', 'groups_with_active_failures')

        # Deleting field 'Inventory.total_hosts'
        db.delete_column(u'main_inventory', 'total_hosts')

        # Deleting field 'Inventory.total_groups'
        db.delete_column(u'main_inventory', 'total_groups')

        # Deleting field 'Inventory.groups_with_active_failures'
        db.delete_column(u'main_inventory', 'groups_with_active_failures')

        # Deleting field 'Inventory.total_inventory_sources'
        db.delete_column(u'main_inventory', 'total_inventory_sources')

        # Deleting field 'Inventory.inventory_sources_with_failures'
        db.delete_column(u'main_inventory', 'inventory_sources_with_failures')
