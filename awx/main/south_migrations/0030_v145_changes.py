...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ActivityStream.user'
        db.rename_column(u'main_activitystream', 'user_id', 'actor_id')

        # Adding M2M table for field user on 'ActivityStream'
        m2m_table_name = db.shorten_name(u'main_activitystream_user')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('activitystream', models.ForeignKey(orm['main.activitystream'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['activitystream_id', 'user_id'])

        # Adding M2M table for field organization on 'ActivityStream'
        m2m_table_name = db.shorten_name(u'main_activitystream_organization')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('activitystream', models.ForeignKey(orm['main.activitystream'], null=False)),
            ('organization', models.ForeignKey(orm['main.organization'], null=False))
        ))
        db.create_unique(m2m_table_name, ['activitystream_id', 'organization_id'])

        # Adding M2M table for field inventory on 'ActivityStream'
        m2m_table_name = db.shorten_name(u'main_activitystream_inventory')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('activitystream', models.ForeignKey(orm['main.activitystream'], null=False)),
            ('inventory', models.ForeignKey(orm['main.inventory'], null=False))
        ))
        db.create_unique(m2m_table_name, ['activitystream_id', 'inventory_id'])

        # Adding M2M table for field host on 'ActivityStream'
        m2m_table_name = db.shorten_name(u'main_activitystream_host')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('activitystream', models.ForeignKey(orm['main.activitystream'], null=False)),
            ('host', models.ForeignKey(orm['main.host'], null=False))
        ))
        db.create_unique(m2m_table_name, ['activitystream_id', 'host_id'])

        # Adding M2M table for field group on 'ActivityStream'
        m2m_table_name = db.shorten_name(u'main_activitystream_group')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('activitystream', models.ForeignKey(orm['main.activitystream'], null=False)),
            ('group', models.ForeignKey(orm['main.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['activitystream_id', 'group_id'])
        ...
        # Adding M2M table for field credential on 'ActivityStream'
        m2m_table_name = db.shorten_name(u'main_activitystream_credential')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('activitystream', models.ForeignKey(orm['main.activitystream'], null=False)),
            ('credential', models.ForeignKey(orm['main.credential'], null=False))
        ))
        db.create_unique(m2m_table_name, ['activitystream_id', 'credential_id'])

        # Adding M2M table for field team on 'ActivityStream'
        m2m_table_name = db.shorten_name(u'main_activitystream_team')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('activitystream', models.ForeignKey(orm['main.activitystream'], null=False)),
            ('team', models.ForeignKey(orm['main.team'], null=False))
        ))
        db.create_unique(m2m_table_name, ['activitystream_id', 'team_id'])
        ...
        # Adding M2M table for field permission on 'ActivityStream'
        m2m_table_name = db.shorten_name(u'main_activitystream_permission')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('activitystream', models.ForeignKey(orm['main.activitystream'], null=False)),
            ('permission', models.ForeignKey(orm['main.permission'], null=False))
        ))
        db.create_unique(m2m_table_name, ['activitystream_id', 'permission_id'])
    ...
    def backwards(self, orm):
        # Adding field 'ActivityStream.user'
        db.add_column(u'main_activitystream', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='activity_stream', null=True, on_delete=models.SET_NULL, to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'ActivityStream.actor'
        db.delete_column(u'main_activitystream', 'actor_id')

        # Removing M2M table for field user on 'ActivityStream'
        db.delete_table(db.shorten_name(u'main_activitystream_user'))

        # Removing M2M table for field organization on 'ActivityStream'
        db.delete_table(db.shorten_name(u'main_activitystream_organization'))

        # Removing M2M table for field inventory on 'ActivityStream'
        db.delete_table(db.shorten_name(u'main_activitystream_inventory'))

        # Removing M2M table for field host on 'ActivityStream'
        db.delete_table(db.shorten_name(u'main_activitystream_host'))

        # Removing M2M table for field group on 'ActivityStream'
        db.delete_table(db.shorten_name(u'main_activitystream_group'))
        ...
        # Removing M2M table for field credential on 'ActivityStream'
        db.delete_table(db.shorten_name(u'main_activitystream_credential'))

        # Removing M2M table for field team on 'ActivityStream'
        db.delete_table(db.shorten_name(u'main_activitystream_team'))
        ...
        # Removing M2M table for field permission on 'ActivityStream'
        db.delete_table(db.shorten_name(u'main_activitystream_permission'))
