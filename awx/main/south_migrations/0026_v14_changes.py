...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Inventory.variables'
        db.alter_column(u'main_inventory', 'variables', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Project.scm_branch'
        db.alter_column(u'main_project', 'scm_branch', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Project.scm_type'
        db.alter_column(u'main_project', 'scm_type', self.gf('django.db.models.fields.CharField')(max_length=8))

        # Changing field 'Project.scm_url'
        db.alter_column(u'main_project', 'scm_url', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'InventorySource.status'
        db.alter_column(u'main_inventorysource', 'status', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'Inventory.variables'
        db.alter_column(u'main_inventory', 'variables', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Project.scm_branch'
        db.alter_column(u'main_project', 'scm_branch', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

        # Changing field 'Project.scm_type'
        db.alter_column(u'main_project', 'scm_type', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))

        # Changing field 'Project.scm_url'
        db.alter_column(u'main_project', 'scm_url', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'InventorySource.status'
        db.alter_column(u'main_inventorysource', 'status', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
