...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename "ip_address" to "hostname".
        db.rename_column(u'main_instance', 'ip_address', 'hostname')

        # Adding field 'Instance.hostname'
        db.alter_column(u'main_instance', 'hostname',
                      self.gf('django.db.models.fields.CharField')(max_length=250))

        db.create_index(u'main_instance', ['hostname'], unique=True)
