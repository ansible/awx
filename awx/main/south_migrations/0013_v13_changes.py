...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.last_updated'
        db.add_column(u'main_project', 'last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Project.status'
        db.add_column(u'main_project', 'status',
                      self.gf('django.db.models.fields.CharField')(default='ok', max_length=32, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.last_updated'
        db.delete_column(u'main_project', 'last_updated')

        # Deleting field 'Project.status'
        db.delete_column(u'main_project', 'status')
