...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Update inventory source from rackspace to rax.
        for inventory_source in orm.InventorySource.objects.all():
            if inventory_source.source == 'rackspace':
    ...
    def backwards(self, orm):
        ...
        # Update inventory source back from rax to rackspace.
        for inventory_source in orm.InventorySource.objects.all():
            if inventory_source.source == 'rax':
                inventory_source.source = 'rackspace'
                inventory_source.save()
