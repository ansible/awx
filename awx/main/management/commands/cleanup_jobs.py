...
class Command(NoArgsCommand):
    ...
    def cleanup_jobs(self):
        ...
        for job in jobs.defer('result_stdout_text').iterator():
    ...
    def cleanup_ad_hoc_commands(self):
        ...
        for ad_hoc_command in ad_hoc_commands.defer('result_stdout_text').iterator():
    ...
    def cleanup_project_updates(self):
        ...
        for pu in project_updates.defer('result_stdout_text').iterator():
    ...
    def cleanup_inventory_updates(self):
        ...
        for iu in inventory_updates.defer('result_stdout_text').iterator():
    ...
    def cleanup_management_jobs(self):
        ...
        for sj in system_jobs.defer('result_stdout_text').iterator():
