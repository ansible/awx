...
from awx.main.models.mixins import ResourceMixin, RelatedJobsMixin, OpaQueryPathMixin

__all__ = ['Organization', 'Team', 'UserSessionMembership']


class Organization(CommonModel, NotificationFieldsModel, ResourceMixin, RelatedJobsMixin, OpaQueryPathMixin):
    """
