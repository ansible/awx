...
class RelayWebsocketStatsManager:
    def __init__(self, event_loop, registry: CollectorRegistry, local_hostname):
    ...
    def new_remote_host_stats(self, remote_hostname):
        self._stats[remote_hostname] = RelayWebsocketStats(self._registry, self._local_hostname, remote_hostname)
...
class RelayWebsocketStats:
    def __init__(self, registry, local_hostname, remote_hostname):
        self._local_hostname = local_hostname
