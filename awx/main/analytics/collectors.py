...
from insights_analytics_collector import CsvFileSplitter, register, slicing
...
@register('config', '1.3', description=_('General platform configuration.'), config=True)
...
@register('events_table', '1.4', format='csv',
          description=_('Automation task records'),
          fnc_slicing=four_hour_slicing)
...
@register('unified_jobs_table', '1.3', format='csv',
          description=_('Data on jobs run'),
          fnc_slicing=four_hour_slicing)
...
@register('unified_job_template_table', '1.1', format='csv',
          description=_('Data on job templates'))
...
@register('workflow_job_node_table', '1.0', format='csv',
          description=_('Data on workflow runs'),
          fnc_slicing=four_hour_slicing)
...
@register('workflow_job_template_node_table', '1.0', format='csv',
