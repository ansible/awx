...
class LaunchConfigurationBaseSerializer(BaseSerializer):
    ...
    def validate(self, attrs):
        ...
        # instance_groups) via the instance pk.  Only re-validate the full
        # prompt state when the caller is switching the underlying template;
        # otherwise restrict validation to the fields the request explicitly
        # provided.
        if 'unified_job_template' in attrs:
