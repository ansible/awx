...
urls = [
    ...
    url(r'^(?P<pk>[0-9]+)/survey_spec/$', JobTemplateSurveySpec.as_view(is_launch=False), name='job_template_survey_spec'),
    url(r'^(?P<pk>[0-9]+)/launch_survey_spec/$', JobTemplateSurveySpec.as_view(is_launch=True), name='job_template_launch_survey_spec'),
