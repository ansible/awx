...
urls = [
    ...
    url(r'^(?P<pk>[0-9]+)/export/$', ProjectExportView.as_view(), name='project_export_view'),
    url(r'^(?P<pk>[0-9]+)/project_exports/$', ProjectExportsList.as_view(), name='project_exports_list'),
