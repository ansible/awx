...
export default {
    ...
    resolve: {
        data: [ function(){
            ...
            //     "display_name": null,
            //     "parent_id": null,
            //     "last_check_in": "2017-05-11T13:24:40.000Z",
            //     "created_at": "2017-05-11T13:24:26.000Z",
            //     "hostname": "37c2ce54c4ec",
            //     "remote_branch": null,
            //     "updated_at": "2017-05-12T18:12:40.000Z",
            //     "reports": [
            //         {
            //             "maintenance_actions": [],
            //             "uuid": "a527f87cf47b4e60abddc0eea71d2a99",
            //             "rule": {
            //                 "retired": false,
            //                 "rec_likelihood": 2,
            //                 "ansible": false,
            //                 "summary": "Third party components, or installation of a distribution that is not Red Hat Enterprise Linux can lead to difficulties in supporting your system.",
            //                 "category": "Stability",
            //                 "severity": "INFO",
            //                 "generic": "These hosts appear to be running a version of Linux other than Red Hat Enterprise Linux, or has components from a third party distribution, in some circumstances, this can mean a support case will be rejected.\n\nYou should confirm that this machine is installed with RHEL and review the [Production Support Scope of Coverage](https://access.redhat.com/support/offerings/production/soc)",
            //                 "type": null,
            //                 "more_info": null,
            ...
            //                 "reboot_required": false,
            //                 "ansible_mitigation": false,
            //                 "reason": "<p>This host appears to be running a version of Linux other than Red Hat Enterprise Linux, or has components from a third party distribution:</p>\n<ul>\n<li>Other Linux: <strong>Unknown kernel</strong></li>\n</ul>\n<ul>\n<li>Kernel: <strong>4.4.47-boot2docker</strong></li>\n</ul>\n",
            //                 "node_id": "1067",
            //                 "generic_html": "<p>These hosts appear to be running a version of Linux other than Red Hat Enterprise Linux, or has components from a third party distribution, in some circumstances, this can mean a support case will be rejected.</p>\n<p>You should confirm that this machine is installed with RHEL and review the <a href=\"https://access.redhat.com/support/offerings/production/soc\">Production Support Scope of Coverage</a></p>\n",
            //                 "active": true,
            //                 "more_info_html": "",
            //                 "plugin": "other_linux_system",
            //                 "summary_html": "<p>Third party components, or installation of a distribution that is not Red Hat Enterprise Linux can lead to difficulties in supporting your system.</p>\n",
            //                 "error_key": "OTHER_LINUX_SYSTEM",
            //                 "publish_date": "2016-10-31T04:08:35.000Z",
            //                 "resolution": "<p>Another version of Linux installed or running on the system can present difficulties when investigating issues with Red Hat Global Support Services.</p>\n<p>Depending on the situation, GSS may require you to demonstrate the problem on a RHEL only installation or be unable to assist and reject your case in accordance with the <a href=\"https://access.redhat.com/support/offerings/production/soc\">Production Support Scope of Coverage</a>.</p>\n",
            //                 "rule_id": "other_linux_system|OTHER_LINUX_SYSTEM",
            //                 "ansible_fix": false
            //             },
            //             "id": 730932995,
            //             "system_id": "231dc5b8-eb0e-46d0-a959-4716108b040c",
            //             "details": {
            //                 "kernel": "4.4.47-boot2docker",
            //                 "other_linux": "Unknown kernel",
            //                 "error_key": "OTHER_LINUX_SYSTEM"
            //             },
            //             "date": "2017-05-11T13:24:40.000Z",
            //             "rule_id": "other_linux_system|OTHER_LINUX_SYSTEM",
            //             "account_number": "1460290"
            //         },
            //         {
            //             "maintenance_actions": ["PLAN: Tonic lab", "PLAN: foobar"],
            //             "uuid": "a527f87cf47b4e60abddc0eea71d2a99",
            //             "rule": {
            //                 "retired": false,
            //                 "rec_likelihood": 3,
            //                 "ansible": false,
            //                 "summary": "During boot time, the system runs a file system check against all devices in the `/etc/fstab` file. If the file system type specified in `/etc/fstab` is not the same as the output of the `mount` command, or the device specified in `etc/fstab` does not exist, the system will not boot successfully.\n",
            //                 "category": "Availability",
            //                 "severity": "ERROR",
            //                 "generic": "During boot time, the system runs a file system check against all devices in the `/etc/fstab` file. If the file system type specified in `/etc/fstab` is not the same as the output of the `mount` command, or the device specified in `etc/fstab` does not exist, the system will not boot successfully.\n",
            //                 "type": "rhel",
            //                 "more_info": null,
            //                 "description": "System will not reboot successfully when there is misconfiguration in /etc/fstab",
            //                 "rec_impact": 3,
            //                 "reboot_required": false,
            //                 "ansible_mitigation": false,
            //                 "reason": "<p>This host will not reboot successfully when there is no entry in <code>/etc/fstab</code>.</p>\n",
            //                 "node_id": "23769",
            //                 "generic_html": "<p>During boot time, the system runs a file system check against all devices in the <code>/etc/fstab</code> file. If the file system type specified in <code>/etc/fstab</code> is not the same as the output of the <code>mount</code> command, or the device specified in <code>etc/fstab</code> does not exist, the system will not boot successfully.</p>\n",
            //                 "active": true,
            //                 "more_info_html": "",
            //                 "plugin": "sanity_check_fstab",
            //                 "summary_html": "<p>During boot time, the system runs a file system check against all devices in the <code>/etc/fstab</code> file. If the file system type specified in <code>/etc/fstab</code> is not the same as the output of the <code>mount</code> command, or the device specified in <code>etc/fstab</code> does not exist, the system will not boot successfully.</p>\n",
            //                 "error_key": "CHECK_FSTAB_ENTRY_ERROR",
            //                 "publish_date": "2017-05-04T00:00:00.000Z",
            //                 "resolution": "<p>To make sure the system can reboot correctly, Red Hat recommends that you add the necessary entries in <code>/etc/fstab</code>.</p>\n",
            //                 "rule_id": "sanity_check_fstab|CHECK_FSTAB_ENTRY_ERROR",
            //                 "ansible_fix": false
            //             },
            //             "id": 730933025,
            //             "system_id": "231dc5b8-eb0e-46d0-a959-4716108b040c",
            ...
            //                 "rec_likelihood": 2,
            //                 "ansible": true,
            //                 "summary": "The grub's configuration file is not getting updated after installing new kernel when symlink missed.\n",
            //                 "category": "Stability",
            //                 "severity": "WARN",
            //                 "generic": "When a new kernel is installed, the installation process updates the grub file under /etc directory which is a symlink to the grub file under /boot directory. If the symlink is deleted and a new regular file is created, the update to the new grub file under /etc directory will not be reflected to the grub file under /boot directory. \n\nFor RHEL6\n* No UEFI: /etc/grub.conf --> /boot/grub/grub.conf\n* With UEFI: /etc/grub.conf --> /boot/efi/EFI/redhat/grub.conf\n\nFor RHEL7\n* No UEFI: /etc/grub2.cfg --> /boot/grub2/grub.cfg\n* With UEFI: /etc/grub2.cfg --> /boot/efi/EFI/redhat/grub.cfg\n",
            //                 "type": null,
            //                 "more_info": null,
            //                 "description": "The grub's configuration file is not getting updated after installing new kernel when symlink missed",
            //                 "rec_impact": 3,
            //                 "reboot_required": false,
            //                 "ansible_mitigation": false,
            //                 "reason": "<p>The symlink of grub configuration under &quot;/etc&quot; on this host was deleted or\nremoved mistakenly. \nHowever, it should be a symlink to the <code>/boot/grub/grub.conf</code> file.</p>\n",
            //                 "node_id": "770663",
            //                 "generic_html": "<p>When a new kernel is installed, the installation process updates the grub file under /etc directory which is a symlink to the grub file under /boot directory. If the symlink is deleted and a new regular file is created, the update to the new grub file under /etc directory will not be reflected to the grub file under /boot directory. </p>\n<p>For RHEL6</p>\n<ul>\n<li>No UEFI: /etc/grub.conf --&gt; /boot/grub/grub.conf</li>\n<li>With UEFI: /etc/grub.conf --&gt; /boot/efi/EFI/redhat/grub.conf</li>\n</ul>\n<p>For RHEL7</p>\n<ul>\n<li>No UEFI: /etc/grub2.cfg --&gt; /boot/grub2/grub.cfg</li>\n<li>With UEFI: /etc/grub2.cfg --&gt; /boot/efi/EFI/redhat/grub.cfg</li>\n</ul>\n",
            //                 "active": true,
            //                 "more_info_html": "",
            //                 "plugin": "missing_grub_symlink",
            //                 "summary_html": "<p>The grub&#39;s configuration file is not getting updated after installing new kernel when symlink missed.</p>\n",
            //                 "error_key": "MISSED_GRUB_SYMLINK_ISSUE",
            //                 "publish_date": "2016-10-31T04:08:31.000Z",
            //                 "resolution": "<p>To resolve the issue, Red Hat recommends that you complete the following steps:</p>\n<ol>\n<li>Update the <code>/boot/grub/grub.conf</code> file content.</li>\n\n<code># cp /etc/grub.conf /boot/grub/grub.conf</code>\n\n<li>Verify the <code>/boot/grub/grub.conf</code> file has been updated with all the entries.</li>\n<li>Remove the <code>/etc/grub.conf</code> file:</li>\n\n<code># rm -f /etc/grub.conf</code>\n\n<li>Create a new symlink to the <code>/boot/grub/grub.conf</code> file:</li>\n\n<code># ln -s /boot/grub/grub.conf /etc/grub.conf</code>\n\n<li>Verify the symlink:</li>\n\n<code># ls -l /etc/grub.conf\nlrwxrwxrwx. 1 root root 22 Jan 14  2016 /etc/grub.conf -&gt; ../boot/grub/grub.conf</code>\n\n</ol>\n",
            ...
            //             "details": {
            //                 "grub_name": "grub.conf",
            //                 "grub_fullname": "/boot/grub/grub.conf",
            //                 "grub_file": "no",
            //                 "error_key": "MISSED_GRUB_SYMLINK_ISSUE"
            //             },
            //             "date": "2017-05-11T13:24:40.000Z",
