...
import WeekDaySubForm from './WeekDaySubform';
import SubFormScheduleType from './SubFormScheduleType';
      ...
      {(frequency === 'hour' ||
        ...
        <div css="display: flex; flex-wrap: wrap; justify-content: center;">
          ...
          {scheduleType === 'weekday' && (
            <WeekDaySubForm frequency={frequency} prefix={prefix} id={id} />
          )}
        </div>
      )}
      {(frequency === 'month' || frequency === 'year') &&
      <MonthYearSubForm prefix={prefix} id={id} frequency={frequency}/>
