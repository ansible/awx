...
import getInventoryHelpTextStrings from '../shared/Inventory.helptext';
...
function InventorySourceDetail({ inventorySource }) {
  ...
  const helpText = getInventoryHelpTextStrings(source, docsBaseUrl, {
    ...
    optionsList = (
      <TextList component={TextListVariants.ul}>
        ...
        {update_on_launch && (
          <TextListItem component={TextListItemVariants.li}>
            {t`Update on launch`}
            <Popover content={helpText.subFormOptions.updateOnLaunch} />
          </TextListItem>
        )}
        {update_on_project_update && (
          <TextListItem component={TextListItemVariants.li}>
            {t`Update on project update`}
            <Popover content={helpText.subFormOptions.updateOnProjectUpdate} />
          </TextListItem>
        )}
      </TextList>
    );
