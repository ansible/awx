    ...
    sourceVars: (
      <>
        <Trans>
          ...
          <a href={docUrls[source]} target="_blank" rel="noopener noreferrer">
            {sourceType}
          </a>{' '}
