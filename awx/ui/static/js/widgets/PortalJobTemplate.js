...
angular.module('PortalJobTemplateWidget', ['RestServices', 'Utilities'])
.factory('PortalJobTemplate', ['$rootScope', '$compile', 'LoadSchedulesScope', 'LoadJobsScope', 'JobsList', 'ScheduledJobsList', 'GetChoices', 'GetBasePath',
    ...
    return function (params) {
     ...
     // Set the height of each container and calc max number of rows containers can hold
        function setPortalJobsHeight() {
            ...
            available_height = Math.floor($(window).height() - $('#main-menu-container .navbar').outerHeight() - $('#refresh-row').outerHeight() - 70);
