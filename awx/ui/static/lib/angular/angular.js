...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.15-build.2398+sha.4bab3d8/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.15-build.2398+sha.4bab3d8',    // all of these placeholder strings will be replaced by grunt's
