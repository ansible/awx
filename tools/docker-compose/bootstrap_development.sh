...
if [ ! -d "/awx_devel/awx/uibuild/awx" ]; then
    mkdir -p /awx_devel/awx/uibuild/awx
    cp /awx_devel/awx/uiplaceholder_index_awx.html /awx_devel/awx/uibuild/awx/index_awx.html
fi
