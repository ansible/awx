...
options:
    ...
    credential_type:
      description:
        ...
        - Choices include Amazon Web Services, Ansible Galaxy/Automation Hub API Token, Centrify Vault Credential Provider Lookup,
          ...
          GitHub Personal Access Token, GitLab Personal Access Token, GPG Public Key, Sigstore, HashiCorp Vault Secret Lookup, HashiCorp Vault Signed SSH,
    ...
    inputs:
      description:
        ...
        - sigstore (Configuration parameters for validating Sigstore signatures)
      type: dict
    update_secrets:
      description:
