...
options:
    ...
    credential:
      description:
        - Credential name or ID to authenticate with Kubernetes or OpenShift.  Must be of type "OpenShift or Kubernetes API Bearer Token".
      required: False
      type: str
    is_container_group:
      description:
    ...
    instances:
      description:
        - The instance names or IDs associated with this instance_group
      required: False
      type: list
      elements: str
    state:
