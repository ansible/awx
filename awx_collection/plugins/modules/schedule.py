...
options:
    ...
    inventory:
      description:
        - Inventory name or ID applied as a prompt, assuming job template prompts for inventory
      required: False
      type: str
    job_slice_count:
      description:
    ...
    credentials:
      description:
        - List of credential names or IDs applied as a prompt, assuming job template prompts for credentials
      type: list
      elements: str
    scm_branch:
      description:
    ...
    unified_job_template:
      description:
        - Name or ID of unified job template to schedule. Used to look up an already existing schedule.
      required: False
      type: str
    organization:
      description:
        - The organization name or ID the unified job template exists in.
