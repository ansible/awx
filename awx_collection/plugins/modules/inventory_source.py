...
options:
    ...
    source:
      ...
      choices: [ "scm", "ec2", "gce", "azure_rm", "vmware", "satellite6", "openstack", "rhv", "controller", "insights", "hcloud" ]
      type: str
    source_path:
      description:
...
def main():
    ...
    argument_spec = dict(
        ...
        #
        source=dict(choices=["scm", "ec2", "gce", "azure_rm", "vmware", "satellite6", "openstack", "rhv", "controller", "insights", "hcloud"]),
        source_path=dict(),
