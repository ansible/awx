...
options:
    ...
    new_name:
      description:
        - A new name for the team. This is used to rename the team.
      required: False
    organization:
      description:
...
def main():
    ...
    team = module.get_one('teams', **{ 'data': { 'name': name, 'organization': org_id } } )
    ...
    if state == 'absent' and not team:
        ...
        result = module.post_endpoint('teams', item_type='team', item_name=name, **{ 'data': { 'name': name, 'organization': org_id } })
    else:
