...
options:
    user:
      description:
        - User name or ID that receives the permissions specified by the role.
        - Deprecated, use 'users'.
      type: str
    users:
      description:
        - User names or IDs that receive the permissions specified by the role.
      type: list
      elements: str
    team:
      description:
        - Team name or ID that receives the permissions specified by the role.
        - Deprecated, use 'teams'.
      type: str
    teams:
      description:
        - Team names or IDs that receive the permissions specified by the role.
      type: list
      elements: str
    role:
      description:
    ...
    target_team:
      description:
        - Team name or ID that the role acts on.
    ...
    target_teams:
      description:
        - Team names or IDs that the role acts on.
        - For example, make someone a member or an admin of a team.
        - Members of a team implicitly receive the permissions that the team has.
      type: list
      elements: str
    inventory:
      description:
        - Inventory name or ID the role acts on.
        - Deprecated, use 'inventories'.
      type: str
    inventories:
      description:
        - Inventory names or IDs the role acts on.
      type: list
      elements: str
    job_template:
      description:
        - The job template name or ID the role acts on.
        - Deprecated, use 'job_templates'.
      type: str
    job_templates:
      description:
        - The job template names or IDs the role acts on.
      type: list
      elements: str
    workflow:
      description:
        - The workflow job template name or ID the role acts on.
        - Deprecated, use 'workflows'.
      type: str
    workflows:
      description:
        - The workflow job template names or IDs the role acts on.
      type: list
      elements: str
    credential:
      description:
        - Credential name or ID the role acts on.
        - Deprecated, use 'credentials'.
      type: str
    credentials:
      description:
        - Credential names or IDs the role acts on.
      type: list
      elements: str
    organization:
      description:
        - Organization name or ID the role acts on.
        - Deprecated, use 'organizations'.
      type: str
    organizations:
      description:
        - Organization names or IDs the role acts on.
      type: list
      elements: str
    lookup_organization:
      description:
        - Organization name or ID the inventories, job templates, projects, or workflows the items exists in.
        - Used to help lookup the object, for organization roles see organization.
        - If not provided, will lookup by name only, which does not work with duplicates.
      type: str
    project:
      description:
        - Project name or ID the role acts on.
        - Deprecated, use 'projects'.
      type: str
    projects:
      description:
        - Project names or IDs the role acts on.
      type: list
      elements: str
    instance_groups:
      description:
        - Instance Group names or IDs the role acts on.
      type: list
      elements: str
    state:
      description:
