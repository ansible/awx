...
def get_job_templates_by_projects(project_ids, credential_ids, notification_templates, awx_auth):
    ...
    return exported_job_templates, credential_ids, notification_templates