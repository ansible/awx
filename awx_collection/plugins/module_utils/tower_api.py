...
class TowerModule(AnsibleModule):
    ...
    def modify_associations(self, association_endpoint, new_association_list):
        ...
        for exisitng_association in response['json']['results']:
            existing_associated_ids.append( exisitng_association['id'] )
        ...
        # Associate anything that is in new_association_list but not in exisitng_association
