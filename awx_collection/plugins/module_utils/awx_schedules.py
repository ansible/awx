...
def get_schedules(workflow_job_template, awx_auth):
    schedules = get_awx_resources(uri='/api/v2/schedules/?unified_job_template='+str(workflow_job_template['id']), previousPageResults=[], awx_auth=awx_auth)
